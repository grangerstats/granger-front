                                        ...
                                        <div className="form-group col-12">
                                            <div className="input-group">
                                                <div className="custom-file">
                                                    ...
                                                    aria-describedby="inputGroupFileAddon01" ref={input => this.nomeUpload = input} 
                                                    onChange={this.handleDados}/>
                                                    <label className="custom-file-label" htmlFor="inputGroupFile01" data-browse="Buscar">Escolha o arquivo</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
